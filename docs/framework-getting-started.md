...
> **Prefer a template?** The [example-app](https://github.com/mctx-ai/example-mcp-server) is a GitHub template — click "Use this template" to get a pre-configured project with CI/CD already set up.
