...
> **Prefer a template?** The [example-mcp-server](https://github.com/new?template_name=example-mcp-server&template_owner=mctx-ai) is a GitHub template — click "Use this template" to get a pre-configured project with CI/CD already set up.
...
- **[Example Server](https://github.com/new?template_name=example-mcp-server&template_owner=mctx-ai)** -- a template repository you can use to start your own server. Click "Use this template" on GitHub, then run `setup.sh` to customize your project
